...
# ts qviol $data/3x2-fin-20D.txt -d 222 -o $data/qviol-bell3x2-20D-222-none.yml
# ts qviol $data/3x2-fin-20D.txt -d 333 -o $data/qviol-bell3x2-20D-333-none.yml
...
# 20D
ts qviol ${prefix}20D-222-none.yml -d 222 -o ${prefix}20D-222-CHSHE.yml -c CHSHE
ts qviol ${prefix}20D-222-none.yml -d 222 -o ${prefix}20D-222-CHSH.yml -c CHSH
ts qviol ${prefix}20D-222-none.yml -d 222 -o ${prefix}20D-222-PPT.yml -c PPT

ts qviol ${prefix}20D-333-none.yml -d 333 -o ${prefix}20D-333-CHSHE.yml -c CHSHE
ts qviol ${prefix}20D-333-none.yml -d 333 -o ${prefix}20D-333-CGLMP.yml -c CGLMP
ts qviol ${prefix}20D-333-none.yml -d 333 -o ${prefix}20D-333-PPT.yml -c PPT
